	   			...
	   			<div class="sixteen wide column">
	   				<div class="ui grid">
	   					...
	   					<div class="ten wide column">
							...
							<p><b>Материал:</b> сосна срощеная высшего сорта;</p>
							<p><b>Производитель:</b> Собственное производство, Россия;</p>
							<p><b>Ширина:</b> 30 мм</p>
							<p><b>Толщина:</b> 15 мм</p>
	   					</div>
	   					<form method="GET">
...
<script>
	$("#wnumber").keyup(function(){$("#numbersum").html( Math.ceil( ( Number($("#wnumber").val()) + Number($("#hnumber").val()) )*(0.9)) )})
	$("#hnumber").keyup(function(){$("#numbersum").html( Math.ceil( ( Number($("#wnumber").val()) + Number($("#hnumber").val()) )*(0.9)) )})
</script>